...
knitr::include_graphics("img/Picture1.jpg")
```
]
]
...
---
# Further monitoring
- A return visit to Shanghai for investigating tree planting using remote sensing.

- Research suggests remote sensing can evaluate carbon sink of forests with proper dataset and methods.
