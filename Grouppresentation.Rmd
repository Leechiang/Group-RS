---
title: "Shanghai Carbon sink"
author: "Jiaming et al." 
...
# Problem statement
.panelset[
.panel[.panel-name[Insufficient green and low-carbon development]

- The demand for energy for high-quality economic development remains high, with the industrial, transport and construction sectors all facing continued development needs.

- Although Shanghai's energy consumption as a percentage of GDP continues to decline, coal still accounts for the largest share of the city's energy mix.

- As the most industrialised city in China, Shanghai shoulders the responsibility of leading the way in carbon emission reduction and carbon neutrality.

]

.panel[.panel-name[Serious underscaling of ecological space]
- The city's forest cover reached 15 per cent in 2015, but it is still far from the global urban forest cover of 40-60 per cent and below the national average of 22 per cent.

- There is a serious lack of urban open space, with 7.6 square metres of parkland per capita, a large gap with national standards.

- Urban sprawl has led to fragmentation and reduction of green space, with significant loss of green space and expansion of built-up area

]

.panel[.panel-name[Frequency of climate extremes]
- The risk of natural disasters continues unabated. More than 90 per cent of the natural disasters that hit Shanghai are meteorological.

- According to meteorological forecasts, the number of days of heavy precipitation and its intensity are on the increase for the next 20 years

- Continuing sea level rise and upstream flood pressure are posing greater challenges to Shanghai's urban resilience to flooding.
]
]
---
# Policy
...
knitr::include_graphics('d41586-018-05842-2_15982792.jpg')
