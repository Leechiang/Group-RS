...
```
.small[The multi-level, networked and functional urban ecological space system consists of "a double ring, 9 ecological corridors and 10 ecological protection zones".]
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics("img/微信图片_20240317114514.png")
```
